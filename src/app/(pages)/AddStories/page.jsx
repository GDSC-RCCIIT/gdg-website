'use client';
import AddStoriesForm from "@/components/Global/AddStoriesForm";
import { Card } from "@/components/ui/card";
import { motion } from "framer-motion";
import { useState, useEffect } from "react";

const AddStoriesSkeleton = () => (
...
const AddStories = () => {
  ...
  return (
    <div className="relative h-[1000px] bg-white flex justify-center items-center overflow-hidden border border-gray-300">
      ...
      <div className="relative z-10 bg-white -mt-32 -mb-24 rounded-lg shadow-lg p-12 w-[1200px] flex"> {/* Changed -mt-60 to -mt-32 */}
        <form className="w-full">
          <div className="text-center">
            ...
            >
              Add a new story so our community can become bigger and better!
            </motion.p>
          </div>
          <AddStoriesForm />
        </form>
