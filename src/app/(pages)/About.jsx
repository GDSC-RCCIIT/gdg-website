export default function About() {
    return (
        <>
            <section>
                <div className="mx-auto max-w-screen-2xl px-4 py-8 sm:px-6 lg:px-8 py-4">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        {/* Blue background div with centered text */}
                        <div className="bg-blue-600 p-8 md:p-12 lg:px-16 lg:py-24 text-center flex flex-col justify-center items-center">
            ...
            <section className="mx-auto max-w-screen-xl px-4 py-8">
                ...
                {/* Flex container for the articles */}
                <div className="flex justify-center gap-x-4">
                    {/* Article 1 */}
                    <article className="hover:animate-background rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s] w-[450px]">
                    ...
                    <article className="hover:animate-background rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s] w-[450px]">
                        <div className="rounded-[10px] bg-white p-4 !pt-20 sm:p-6">
                            ...
                            <a href="#">
                                <h3 className="mt-0.5 text-lg font-medium text-gray-900">
                                    We are here to guide and help our own
                                </h3>
                            </a>
                    ...
                    <article className="hover:animate-background rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s] w-[450px]">
                        <div className="rounded-[10px] bg-white p-4 !pt-20 sm:p-6">
                            ...
                            <a href="#">
                                <h3 className="mt-0.5 text-lg font-medium text-gray-900">
                                    We are always ready for the world
                                </h3>
                            </a>
