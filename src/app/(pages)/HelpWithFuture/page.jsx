'use client'
import HelpWithFutureForm from "@/components/Global/HelpWithFutureForm";
import { Card } from "@/components/ui/card";
import { motion } from "framer-motion";
import { useState, useEffect } from "react";

const HelpWithFutureSkeleton = () => (
...
const HelpWithFuture = () => {
  ...
  if (loading) {
    return <HelpWithFutureSkeleton />;
  }

  return (
    <div className="relative h-[2500px] bg-white flex justify-center items-center overflow-hidden border border-gray-300">
      <motion.div
      ...
      {/* Centered White Box */}
      <div className="relative z-10 bg-white -mt-60 -mb-24 rounded-lg shadow-lg p-12 w-[1200px] h-[2000px] flex ">
        ...
        <div className="text-center">
          ...
          >
            Let Us Help You Choose Your Path
          </motion.h1>

          <motion.p
            className="text-gray-600 text-xl mt-4 mb-8 max-w-3xl mx-auto"
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            Answer these questions and we will try to help you find your right passion.
          </motion.p>
        </div>
          <HelpWithFutureForm/>
