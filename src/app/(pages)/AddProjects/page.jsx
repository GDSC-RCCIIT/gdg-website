...
const AddProject = () => {
  ...
  if (loading) {
    return <AddProjectSkeleton />;
  }

  return (
    <div className="relative h-[4000px] bg-white flex justify-center items-center overflow-hidden border border-gray-300">
      <motion.div
      ...
      {/* Centered White Box */}
      <div className="relative z-10 bg-white -mt-60 -mb-24 rounded-lg shadow-lg p-12 w-[1200px] h-[3300px] flex ">
        ...
        <div className="text-center">
          ...
          >
            Add a new Project that the GDSC developers have built right now!
          </motion.p>
        </div>
        <ProjectForm/>
